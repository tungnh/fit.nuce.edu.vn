...
namespace thanhhoa.gov.vn.Utility
{
    public static class FileRepository
    {
        public static String RootStorage
        {
            get
            {
                return AppDomain.CurrentDomain.BaseDirectory + "\\App_Data\\DiemThi\\";
            }
        }

        public static String ChirldStorage
        {
            get
            {
                return AppDomain.CurrentDomain.BaseDirectory + "\\Upload\\DiemThi\\";
            }
        }
