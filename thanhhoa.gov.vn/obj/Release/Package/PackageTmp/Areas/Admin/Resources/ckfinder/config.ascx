...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type = ResourceType.Add("AnhThe");
        type.Url = BaseUrl + "AnhThe/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "AnhThe/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
        ...
        type = ResourceType.Add("TinTuc");
        type.Url = BaseUrl + "TinTuc/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "TinTuc/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
        type.DeniedExtensions = new string[] { };
		...
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "swf", "flv", "mp3", "mp4" };
		type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("VanBan");
        type.Url = BaseUrl + "VanBan/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "VanBan/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "doc", "docx", "pdf", "ppt", "pptx","xls", "xlsx", "rtf", "htm", "html", "txt"};
        type.DeniedExtensions = new string[] { };
	}
